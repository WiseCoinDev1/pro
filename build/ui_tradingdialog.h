...
public:
    ...
    QLabel *label_11;
    QLabel *HMBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *HMAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *HMPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        HMAvailableLabel = new QLabel(BuyTab);
        HMAvailableLabel->setObjectName(QStringLiteral("HMAvailableLabel"));
        QPalette palette1;
        ...
        HMAvailableLabel->setPalette(palette1);
        HMAvailableLabel->setFont(font3);
        HMAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(HMAvailableLabel);

        labelHM = new QLabel(BuyTab);
        labelHM->setObjectName(QStringLiteral("labelHM"));
        labelHM->setFont(font3);

        horizontalLayout->addWidget(labelHM);
        ...
        UnitsInputHM = new QLineEdit(BuyTab);
        UnitsInputHM->setObjectName(QStringLiteral("UnitsInputHM"));
        UnitsInputHM->setMinimumSize(QSize(0, 0));
        UnitsInputHM->setFont(font5);

        gridLayout_6->addWidget(UnitsInputHM, 4, 9, 1, 1);
        ...
        BuyHM = new QPushButton(BuyTab);
        BuyHM->setObjectName(QStringLiteral("BuyHM"));

        gridLayout_6->addWidget(BuyHM, 7, 3, 1, 1);

        SellHMBTN = new QPushButton(BuyTab);
        SellHMBTN->setObjectName(QStringLiteral("SellHMBTN"));

        gridLayout_6->addWidget(SellHMBTN, 7, 9, 1, 1);
        ...
        HMDemand = new QLabel(BuyTab);
        HMDemand->setObjectName(QStringLiteral("HMDemand"));
        QFont font6;
        font6.setPointSize(8);
        HMDemand->setFont(font6);
        HMDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(HMDemand, 0, 1, 1, 5);

        HMSupply = new QLabel(BuyTab);
        HMSupply->setObjectName(QStringLiteral("HMSupply"));
        HMSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(HMSupply, 0, 9, 1, 3);
        ...
        BittrexHMLabel = new QLabel(tab);
        BittrexHMLabel->setObjectName(QStringLiteral("BittrexHMLabel"));
        QPalette palette7;
        ...
        BittrexHMLabel->setPalette(palette7);
        BittrexHMLabel->setFont(font7);
        BittrexHMLabel->setAutoFillBackground(false);
        BittrexHMLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexHMLabel);
        ...
        HMBalanceLabel = new QLabel(BalanceTab);
        HMBalanceLabel->setObjectName(QStringLiteral("HMBalanceLabel"));
        HMBalanceLabel->setFont(font4);
        HMBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HMBalanceLabel, 0, 3, 1, 1);
        ...
        HMAvailableLabel_2 = new QLabel(BalanceTab);
        HMAvailableLabel_2->setObjectName(QStringLiteral("HMAvailableLabel_2"));
        HMAvailableLabel_2->setFont(font4);
        HMAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HMAvailableLabel_2, 1, 3, 1, 1);
        ...
        HMPendingLabel = new QLabel(BalanceTab);
        HMPendingLabel->setObjectName(QStringLiteral("HMPendingLabel"));
        HMPendingLabel->setFont(font4);
        HMPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HMPendingLabel, 2, 3, 1, 1);
        ...
        HMBalanceLabel->raise();
        HMAvailableLabel_2->raise();
        HMPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "ILM Available:", 0));
        HMAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", 0));
        labelHM->setText(QApplication::translate("tradingDialog", " ILM", 0));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_4->setText(QApplication::translate("tradingDialog", "ILM", 0));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", 0));
        label_22->setText(QApplication::translate("tradingDialog", "ILM", 0));
        ...
        BuyHM->setText(QApplication::translate("tradingDialog", "Buy ILM", 0));
        SellHMBTN->setText(QApplication::translate("tradingDialog", "Sell ILM", 0));
        ...
        HMDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 ILM", 0));
        HMSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 ILM", 0));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in ILM:", 0));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_35->setText(QApplication::translate("tradingDialog", "ILM", 0));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "ILM Balance:", 0));
        BittrexHMLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", 0));
        label_30->setText(QApplication::translate("tradingDialog", "ILM", 0));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "ILM Balance:", 0));
        HMBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "ILM Available:", 0));
        HMAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "ILM Pending:", 0));
        HMPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", 0));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate ILM Coin Deposit Address", 0));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw ILM:", 0));
