...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Illuminum", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Illuminum</b> version", 0));
...
"Copyright \302\251 2017 The Illuminum Developers", 0));
