...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 ILM"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 ILM"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 ILM"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 ILM"));
