...
const int FREEDESKTOP_NOTIFILMATION_ILMON_SIZE = 128;
...
void Notificator::notifyDBus(Class cls, const QString &title, const QString &text, const QIcon &icon, int millisTimeout)
{
    ...
    hints["icon_data"] = FreedesktopImage::toVariant(tmpicon.pixmap(FREEDESKTOP_NOTIFILMATION_ILMON_SIZE).toImage());
    args.append(hints);
