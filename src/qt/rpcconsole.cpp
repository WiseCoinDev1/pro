...
const QSize ILMON_SIZE(24, 24);

const int INITIAL_TRAFFILM_GRAPH_MINS = 30;
...
/**
 * Split Illuminum command line into a list of arguments. Aims to emulate \c bash and friends.
 *
    ...
    banTableContextMenu(0)
{
    ...
    startExecutor();
    setTrafficGraphRange(INITIAL_TRAFFILM_GRAPH_MINS);
...
void RPCConsole::clear()
{
    ...
    for(int i=0; ILMON_MAPPING[i].url; ++i)
    {
        ui->messagesWidget->document()->addResource(
                    QTextDocument::ImageResource,
                    QUrl(ILMON_MAPPING[i].url),
                    QImage(ILMON_MAPPING[i].source).scaled(ILMON_SIZE, Qt::IgnoreAspectRatio, Qt::SmoothTransformation));
    }
    ...
    message(CMD_REPLY, (tr("Welcome to the Illuminum RPC console.") + "<br>" +
