...
const string strMessageMagic = "Illuminum Signed Message:\n";
                        ...
                        bool* pfMissingInputs, bool fRejectInsaneFee, bool ignoreFees)
{
...

    {
        ...
        // instance the STRILMTENC flag was incorrectly allowing certain
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    int64_t nSubsidy = STATILM_POS_REWARD;
...
static int64_t nTargetTimespan = 60 * 60;  // 60 mins
...
{
    RenameThread("Illuminum-loadblk");
