...
public:
    ...
    enum MessageBoxFlags
    {
         ...
         */
        ILMON_MASK = (ILMON_INFORMATION | ILMON_WARNING | ILMON_ERROR),
        ...
        MSG_INFORMATION = (ILMON_INFORMATION | BTN_OK),
        MSG_WARNING = (ILMON_WARNING | BTN_OK | MODAL),
        MSG_ERROR = (ILMON_ERROR | BTN_OK | MODAL)
    };
